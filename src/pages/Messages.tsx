...
import { ShieldCheck, Send, Loader2, Lock, MessageCircle, Clock } from "lucide-react";
      ...
      <div className="flex min-h-screen bg-background">
        ...
        <main className="flex-1 flex items-center justify-center p-6">
          <div className="max-w-md text-center">
            ...
            <h2 className="text-xl font-extrabold text-foreground mb-2">Messagerie réservée aux Témoins</h2>
            <p className="text-sm text-muted-foreground mb-4">
              Pour accéder à la messagerie privée, tu dois obtenir le statut <span className="font-bold text-primary">Témoin</span> en vérifiant ton email universitaire.
            </p>
            <div className="rounded-3xl border border-primary/20 bg-primary/5 p-4">
              <div className="flex items-center gap-2 text-xs text-muted-foreground">
                <ShieldCheck className="h-4 w-4 text-primary" />
                <span>Cette restriction protège la communauté contre le spam et les abus.</span>
              </div>
            </div>
          </div>
        </main>
